...
- **What-if · 배치 제안** — 우체국이 문을 닫으면 멀어지는 사람과 **생활 거점을 모두 잃는 사람**, 닫거나 열 때 영향이 작거나 효과가 큰 곳
...
<tr>
<td><img src="docs/images/whatif.jpg" alt="What-if — 의성우체국이 문을 닫는다면"><br><sub><b>What-if</b> · 닫힌다면 — 영향 인구·늘어나는 거리·생활 거점 상실</sub></td>
<td><img src="docs/images/plan.jpg" alt="배치 제안 — 의성군 닫을 곳 찾기"><br><sub><b>배치 제안</b> · 영향이 작은 순서 + 생활 거점을 잃는 주민 경고</sub></td>
</tr>
<tr>
...
지도는 마우스를 올리지 않아도 핵심 지역이 **라벨**(순위·값·원인)로 보이고, 지역을 누르면(터치 포함) 정보가 **고정**됩니다(ADR-016).
